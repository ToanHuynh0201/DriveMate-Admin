...
export function NotificationBell() {
  ...
  return (
    <div className="notif-bell" ref={ref}>
      <button className="notif-bell__btn" onClick={handleToggle} aria-label="Thông báo">
      ...
      {open && (
        <div className="notif-bell__dropdown">
          <div className="notif-bell__header">
            <span>Thông báo</span>
            {unreadCount > 0 && <span className="notif-bell__unread-count">{unreadCount} chưa đọc</span>}
          </div>
          {loading ? (
            <div className="notif-bell__empty">Đang tải...</div>
          ) : notifications.length === 0 ? (
            <div className="notif-bell__empty">Không có thông báo mới.</div>
          ) : (
